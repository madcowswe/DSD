...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog     "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/first_nios2_system_sdram_0_test_component.v"        -work first_nios2_system_tb_sdram_0                                                                  -cdslib ./cds_libs/first_nios2_system_tb_sdram_0.cds.lib                                                                 
  ...
  ncvlog     "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/first_nios2_system_cpu_mult_cell.v"                 -work first_nios2_system_tb_cpu                                                                      -cdslib ./cds_libs/first_nios2_system_tb_cpu.cds.lib                                                                     
  ...
  ncvlog     "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/altera_sdram_partner_module.v"                      -work first_nios2_system_tb_sdram_0_my_partner                                                       -cdslib ./cds_libs/first_nios2_system_tb_sdram_0_my_partner.cds.lib                                                      
