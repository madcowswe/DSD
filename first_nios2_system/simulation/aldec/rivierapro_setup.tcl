...
# ACDS 12.1 177 win32 2013.02.26.02:02:26
...
alias com {
  echo "\[exec\] com"
  vlog  "$QSYS_SIMDIR/submodules/first_nios2_system_irq_mapper.sv"                                   -work irq_mapper                                                              
  ...
  vlog  "$QSYS_SIMDIR/submodules/first_nios2_system_rsp_xbar_mux_001.sv"                             -work rsp_xbar_mux_001                                                        
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                        -work rsp_xbar_mux                                                            
  vlog  "$QSYS_SIMDIR/submodules/first_nios2_system_rsp_xbar_mux.sv"                                 -work rsp_xbar_mux                                                            
  vlog  "$QSYS_SIMDIR/submodules/first_nios2_system_rsp_xbar_demux_001.sv"                           -work rsp_xbar_demux_001                                                      
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                        -work cmd_xbar_mux_001                                                        
  vlog  "$QSYS_SIMDIR/submodules/first_nios2_system_cmd_xbar_mux_001.sv"                             -work cmd_xbar_mux_001                                                        
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                        -work cmd_xbar_mux                                                            
  vlog  "$QSYS_SIMDIR/submodules/first_nios2_system_cmd_xbar_mux.sv"                                 -work cmd_xbar_mux                                                            
  vlog  "$QSYS_SIMDIR/submodules/first_nios2_system_cmd_xbar_demux_002.sv"                           -work cmd_xbar_demux_002                                                      
  vlog  "$QSYS_SIMDIR/submodules/first_nios2_system_cmd_xbar_demux_001.sv"                           -work cmd_xbar_demux_001                                                      
  vlog  "$QSYS_SIMDIR/submodules/first_nios2_system_cmd_xbar_demux.sv"                               -work cmd_xbar_demux                                                          
  ...
  vlog  "$QSYS_SIMDIR/submodules/first_nios2_system_id_router_002.sv"                                -work id_router_002                                                           
  vlog  "$QSYS_SIMDIR/submodules/first_nios2_system_id_router_001.sv"                                -work id_router_001                                                           
  vlog  "$QSYS_SIMDIR/submodules/first_nios2_system_id_router.sv"                                    -work id_router                                                               
  vlog  "$QSYS_SIMDIR/submodules/first_nios2_system_addr_router_002.sv"                              -work addr_router_002                                                         
  vlog  "$QSYS_SIMDIR/submodules/first_nios2_system_addr_router_001.sv"                              -work addr_router_001                                                         
  vlog  "$QSYS_SIMDIR/submodules/first_nios2_system_addr_router.sv"                                  -work addr_router                                                             
  ...
  vlog  "$QSYS_SIMDIR/submodules/first_nios2_system_cpu_custom_instruction_master_multi_xconnect.sv" -work cpu_custom_instruction_master_multi_xconnect                            
