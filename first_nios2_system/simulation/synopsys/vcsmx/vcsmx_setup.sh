...
# ACDS 12.0 178 win32 2013.02.23.21:35:21
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_customins_slave_translator.sv"                               -work first_nios2_system_cpu_custom_instruction_master_multi_slave_translator0                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/first_nios2_system_cpu_custom_instruction_master_multi_xconnect.sv" -work first_nios2_system_cpu_custom_instruction_master_multi_xconnect                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altera_customins_master_translator.v"                               -work first_nios2_system_cpu_custom_instruction_master_translator                                
  vlogan +v2k           "$QSYS_SIMDIR/submodules/fp_cust_insn.v"                                                     -work first_nios2_system_fp_cust_insn_0                                                          
  vlogan +v2k           "$QSYS_SIMDIR/submodules/first_nios2_system_altpll_0.vo"                                     -work first_nios2_system_altpll_0                                                                
