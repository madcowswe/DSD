...
# ACDS 12.0sp2 263 win32 2013.02.23.23:04:17
...
alias com {
  echo "\[exec\] com"
  vlog -sv "$QSYS_SIMDIR/submodules/first_nios2_system_irq_mapper.sv"                   -work first_nios2_system_irq_mapper                                                              
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_width_adapter.sv"                     -work first_nios2_system_width_adapter                                                           
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                -work first_nios2_system_width_adapter                                                           
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                        -work first_nios2_system_rsp_xbar_mux_001                                                        
  vlog -sv "$QSYS_SIMDIR/submodules/first_nios2_system_rsp_xbar_mux_001.sv"             -work first_nios2_system_rsp_xbar_mux_001                                                        
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                        -work first_nios2_system_rsp_xbar_mux                                                            
  vlog -sv "$QSYS_SIMDIR/submodules/first_nios2_system_rsp_xbar_mux.sv"                 -work first_nios2_system_rsp_xbar_mux                                                            
  vlog -sv "$QSYS_SIMDIR/submodules/first_nios2_system_rsp_xbar_demux_002.sv"           -work first_nios2_system_rsp_xbar_demux_002                                                      
  vlog -sv "$QSYS_SIMDIR/submodules/first_nios2_system_rsp_xbar_demux.sv"               -work first_nios2_system_rsp_xbar_demux                                                          
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                        -work first_nios2_system_cmd_xbar_mux                                                            
  vlog -sv "$QSYS_SIMDIR/submodules/first_nios2_system_cmd_xbar_mux.sv"                 -work first_nios2_system_cmd_xbar_mux                                                            
  vlog -sv "$QSYS_SIMDIR/submodules/first_nios2_system_cmd_xbar_demux_001.sv"           -work first_nios2_system_cmd_xbar_demux_001                                                      
  vlog -sv "$QSYS_SIMDIR/submodules/first_nios2_system_cmd_xbar_demux.sv"               -work first_nios2_system_cmd_xbar_demux                                                          
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter.sv"                     -work first_nios2_system_burst_adapter                                                           
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"                   -work first_nios2_system_limiter                                                                 
  vlog     "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                   -work first_nios2_system_limiter                                                                 
  vlog -sv "$QSYS_SIMDIR/submodules/first_nios2_system_id_router_002.sv"                -work first_nios2_system_id_router_002                                                           
  vlog -sv "$QSYS_SIMDIR/submodules/first_nios2_system_id_router_001.sv"                -work first_nios2_system_id_router_001                                                           
  vlog -sv "$QSYS_SIMDIR/submodules/first_nios2_system_id_router.sv"                    -work first_nios2_system_id_router                                                               
  vlog -sv "$QSYS_SIMDIR/submodules/first_nios2_system_addr_router_001.sv"              -work first_nios2_system_addr_router_001                                                         
  vlog -sv "$QSYS_SIMDIR/submodules/first_nios2_system_addr_router.sv"                  -work first_nios2_system_addr_router                                                             
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                       -work first_nios2_system_cpu_jtag_debug_module_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                -work first_nios2_system_cpu_jtag_debug_module_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                      -work first_nios2_system_cpu_instruction_master_translator_avalon_universal_master_0_agent       
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                  -work first_nios2_system_cpu_jtag_debug_module_translator                                        
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                 -work first_nios2_system_cpu_instruction_master_translator                                       
  vlog     "$QSYS_SIMDIR/submodules/first_nios2_system_sdram_0.v"                       -work first_nios2_system_sdram_0                                                                 
  vlog     "$QSYS_SIMDIR/submodules/first_nios2_system_sdram_0_test_component.v"        -work first_nios2_system_sdram_0                                                                 
  ...
  vlog     "$QSYS_SIMDIR/submodules/first_nios2_system_cpu_mult_cell.v"                 -work first_nios2_system_cpu                                                                     
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L first_nios2_system_irq_mapper -L first_nios2_system_width_adapter -L first_nios2_system_rsp_xbar_mux_001 -L first_nios2_system_rsp_xbar_mux -L first_nios2_system_rsp_xbar_demux_002 -L first_nios2_system_rsp_xbar_demux -L first_nios2_system_cmd_xbar_mux -L first_nios2_system_cmd_xbar_demux_001 -L first_nios2_system_cmd_xbar_demux -L first_nios2_system_rst_controller -L first_nios2_system_burst_adapter -L first_nios2_system_limiter -L first_nios2_system_id_router_002 -L first_nios2_system_id_router_001 -L first_nios2_system_id_router -L first_nios2_system_addr_router_001 -L first_nios2_system_addr_router -L first_nios2_system_cpu_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L first_nios2_system_cpu_jtag_debug_module_translator_avalon_universal_slave_0_agent -L first_nios2_system_cpu_instruction_master_translator_avalon_universal_master_0_agent -L first_nios2_system_cpu_jtag_debug_module_translator -L first_nios2_system_cpu_instruction_master_translator -L first_nios2_system_sdram_0 -L first_nios2_system_led_pio -L first_nios2_system_sysid -L first_nios2_system_sys_clk_timer -L first_nios2_system_jtag_uart -L first_nios2_system_cpu -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiii_ver $TOP_LEVEL_NAME
}
