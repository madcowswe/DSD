...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/first_nios2_system_cpu_custom_instruction_master_multi_xconnect.sv" -work cpu_custom_instruction_master_multi_xconnect                             -cdslib ./cds_libs/cpu_custom_instruction_master_multi_xconnect.cds.lib                            
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/first_nios2_system_cpu.v"                                           -work cpu                                                                      -cdslib ./cds_libs/cpu.cds.lib                                                                     
