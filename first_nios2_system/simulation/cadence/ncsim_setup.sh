...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/first_nios2_system_sdram_0_test_component.v"        -work first_nios2_system_sdram_0                                                                  -cdslib ./cds_libs/first_nios2_system_sdram_0.cds.lib                                                                 
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/first_nios2_system_cpu_mult_cell.v"                 -work first_nios2_system_cpu                                                                      -cdslib ./cds_libs/first_nios2_system_cpu.cds.lib                                                                     
