...
//VERSION_BEGIN 12.1SP1 cbx_altbarrel_shift 2013:01:31:18:05:07:SJ cbx_altfp_add_sub 2013:01:31:18:05:07:SJ cbx_altpriority_encoder 2013:01:31:18:05:07:SJ cbx_cycloneii 2013:01:31:18:05:07:SJ cbx_lpm_add_sub 2013:01:31:18:05:07:SJ cbx_lpm_compare 2013:01:31:18:05:07:SJ cbx_mgl 2013:01:31:18:08:27:SJ cbx_stratix 2013:01:31:18:05:07:SJ cbx_stratixii 2013:01:31:18:05:07:SJ  VERSION_END
...
module  fpsub_altbarrel_shift_q3e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fpsub_altbarrel_shift_q3e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpsub_altbarrel_shift_fkb
	( 
	data,
	distance,
	result) ;
	...
	assign
		...
		sel_w = {distance[4:0]},
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //fpsub_altbarrel_shift_fkb
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpsub_altfp_add_sub_u4j
	( 
	clock,
	dataa,
	datab,
	...
	fpsub_altbarrel_shift_q3e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fpsub_altbarrel_shift_fkb   rbarrel_shift
	( 
...
endmodule //fpsub_altfp_add_sub_u4j
//VALID FILE
...
module fpsub (
	...
	fpsub_altfp_add_sub_u4j	fpsub_altfp_add_sub_u4j_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fpsub_bb.v FALSE
